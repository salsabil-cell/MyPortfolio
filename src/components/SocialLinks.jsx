...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin, 
    url: "https://www.linkedin.com/in/salsabil-wechteti/",
    color: "#0A66C2",
...

  {
    ...
    subText: "@Salsabil",
    icon: Github,
    url: "https://github.com/salsabil-cell",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const github = otherLinks[0];  // only github here, no youtube
          ...
          {[github].map((link) => (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 pointer-events-none overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
               +++F               translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
              </div>
            </a>
          ))}
        </div>
