...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 mt-4 ml-" data-aos="zoom-in" data-aos-delay="400">
...
const MainTitle = memo(() => (
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-7xl font-bold tracking-tight">
  ...
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-3">
      ...
      <div className="relative rounded-xl bg-black/50 backdrop-blur-xl p-2 flex items-center justify-center border border-white/10 group-hover:border-white/20 transition-all duration-300">
        <Icon className="w-5 h-4 text-gray-400 group-hover:text-white transition-colors" />
      </div>
    </button>
  </a>
));
...
const WORDS = ["ADVANCED ELECTRONICS AND NANOTECHNOLOGY ENGINEER", "Tech Enthusiast"];
const TECH_STACK = ["React", "Angular","Javascript", "Node.js", "Tailwind","Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/salsabil-cell" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/salsabil-wechteti/" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Designing innovative, functional, and user-friendly websites tailored for digital solutions
                </p>
